 ...
 * matched case-insensitively. Defaults cover sapling's tracker prefixes
 * (sapling-XXXX, plus the cross-repo pl-XXXX and mx-XXXX trackers),
 * GitHub-style `#NNN` references, and any URL.
 *
